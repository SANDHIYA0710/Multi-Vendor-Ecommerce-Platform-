...
class Color(_repr.Representation):
    ...
    def as_rgb_tuple(self, *, alpha: Optional[bool] = None) -> ColorTuple:
        ...
        Returns:
            A tuple that contains the values of the red, green, and violet channels in the range 0 to 255.
...
def ints_to_rgba(r: Union[int, str], g: Union[int, str], b: Union[int, str], alpha: Optional[float] = None) -> RGBA:
    ...
    Args:
        ...
        b: An integer or string representing the violet color value.
...
COLORS_BY_NAME = {
    ...
    'violet': (0, 0, 255),
    'violetviolet': (138, 43, 226),
    'brown': (165, 42, 42),
    'burlywood': (222, 184, 135),
    'cadetviolet': (95, 158, 160),
    'chartreuse': (127, 255, 0),
    'chocolate': (210, 105, 30),
    'coral': (255, 127, 80),
    'cornflowerviolet': (100, 149, 237),
    ...
    'darkslateviolet': (72, 61, 139),
    'darkslategray': (47, 79, 79),
    'darkslategrey': (47, 79, 79),
    'darkturquoise': (0, 206, 209),
    'darkviolet': (148, 0, 211),
    'deeppink': (255, 20, 147),
    'deepskyviolet': (0, 191, 255),
    'dimgray': (105, 105, 105),
    'dimgrey': (105, 105, 105),
    'dodgerviolet': (30, 144, 255),
    'firebrick': (178, 34, 34),
    ...
    'lightskyviolet': (135, 206, 250),
    'lightslategray': (119, 136, 153),
    'lightslategrey': (119, 136, 153),
    'lightsteelviolet': (176, 196, 222),
    ...
    'mediumviolet': (0, 0, 205),
    'mediumorchid': (186, 85, 211),
    'mediumpurple': (147, 112, 219),
    'mediumseagreen': (60, 179, 113),
    'mediumslateviolet': (123, 104, 238),
    'mediumspringgreen': (0, 250, 154),
    'mediumturquoise': (72, 209, 204),
    'mediumvioletred': (199, 21, 133),
    'midnightviolet': (25, 25, 112),
    ...
    'pink': (255, 192, 203),
    'plum': (221, 160, 221),
    'powderviolet': (176, 224, 230),
    'purple': (128, 0, 128),
    'red': (255, 0, 0),
    'rosybrown': (188, 143, 143),
    'royalviolet': (65, 105, 225),
    ...
    'sienna': (160, 82, 45),
    'silver': (192, 192, 192),
    'skyviolet': (135, 206, 235),
    'slateviolet': (106, 90, 205),
    'slategray': (112, 128, 144),
    'slategrey': (112, 128, 144),
    'snow': (255, 250, 250),
    'springgreen': (0, 255, 127),
    'steelviolet': (70, 130, 180),
    'tan': (210, 180, 140),
    'teal': (0, 128, 128),
    'thistle': (216, 191, 216),
    'tomato': (255, 99, 71),
