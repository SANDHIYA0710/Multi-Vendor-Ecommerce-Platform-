  ...
  return (
    <DashboardLayout role={role}>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_420px] gap-6">
        <div className="bg-white/95 backdrop-blur-xl border-b border-violet-100 rounded-3xl shadow p-8">
          <div className="flex items-center gap-5 mb-8">
            <div className="h-20 w-20 rounded-full bg-violet-100 flex items-center justify-center text-4xl">
              👤
            </div>
        ...
        <div className="space-y-6">
          <form
            ...
            className="bg-white/95 backdrop-blur-xl border-b border-violet-100 rounded-3xl shadow p-6"
          >
            <h2 className="text-xl font-bold text-slate-900 mb-4">Edit Profile</h2>

            <label className="font-semibold text-sm">Name</label>
            <input
              className="border rounded-xl p-3 w-full mt-2 outline-none focus:ring-2 focus:ring-violet-600"
              value={name}
              onChange={(e) => setName(e.target.value)}
              required
            />

            <button className="w-full bg-gradient-to-r from-violet-700 to-purple-600 text-white shadow-xl py-3 rounded-xl font-semibold mt-5">
              Save Changes
            </button>
          </form>
          ...
          >
            ...
            <input
              className="border rounded-xl p-3 w-full mt-2 mb-4 outline-none focus:ring-2 focus:ring-violet-600"
              type="password"
