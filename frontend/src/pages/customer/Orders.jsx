    ...
    <DashboardLayout role="customer">
      ...
      {orders.length === 0 ? (
        ...
        <div className="space-y-5">
          {orders.map((order) => (
            <div key={order.id} className="bg-white/95 backdrop-blur-xl border-b border-violet-100 rounded-3xl shadow p-6">
                    ...
                    {canReview(order.status) &&
                      (reviewStatus[item.product_id]?.reviewed ? (
                        ...
                        <Link
                          ...
                          className="bg-gradient-to-r from-violet-700 to-purple-600 text-white shadow-xl px-4 py-2 rounded-xl font-semibold text-center"
                        >
                          ⭐ Review Product
                        </Link>
                      ))}
              ...
              <div className="flex justify-between items-center mt-5 pt-4 border-t">
                <p className="text-slate-700 font-medium">Total Amount</p>
