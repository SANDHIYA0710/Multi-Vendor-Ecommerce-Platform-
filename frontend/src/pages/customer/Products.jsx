  ...
  return (
    <DashboardLayout role="customer">
      ...
      <form
        ...
        className="bg-white/95 backdrop-blur-xl border-b border-violet-100 p-4 rounded-3xl shadow mb-6 grid grid-cols-1 md:grid-cols-7 gap-3"
      >
        <input
          className="border rounded-xl p-3 outline-none focus:ring-2 focus:ring-violet-600"
        ...
        <button className="bg-violet-700 hover:bg-violet-800 text-white px-4 py-3 rounded-xl font-semibold">
          Search
        </button>
        <button
          type="button"
      ...
      {products.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
          {products.map((product) => (
            <div
              key={product.id}
              className="bg-white/95 backdrop-blur-xl border-b border-violet-100 rounded-3xl shadow hover:shadow-xl transition overflow-hidden"
            >
      ...
      <div className="flex items-center justify-center gap-3 mt-8">
        ...
        <span className="bg-white/95 backdrop-blur-xl border-b border-violet-100 px-5 py-3 rounded-xl shadow">
          Page {filters.page}
        </span>
