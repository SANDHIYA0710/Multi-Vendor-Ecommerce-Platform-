...
function Cart() {
  ...
  return (
    <DashboardLayout role="customer">
      ...
      {cartItems.length === 0 ? (
        <div className="bg-white/95 backdrop-blur-xl border-b border-violet-100 rounded-3xl shadow p-12 text-center">
          ...
          <Link
            ...
            className="inline-block bg-gradient-to-r from-violet-700 to-purple-600 text-white shadow-xl px-6 py-3 rounded-xl font-semibold mt-6"
          >
            Browse Products
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1fr_380px] gap-6">
          <div className="space-y-4">
            {cartItems.map((item) => (
              <div
                key={item.id}
                className="bg-white/95 backdrop-blur-xl border-b border-violet-100 rounded-3xl shadow p-5 flex flex-col md:flex-row gap-5 md:items-center justify-between"
              >
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    value={item.quantity}
                    min="1"
                    className="border rounded-xl p-3 w-24 outline-none focus:ring-2 focus:ring-violet-600"
          ...
          <div className="bg-white/95 backdrop-blur-xl border-b border-violet-100 rounded-3xl shadow p-6 h-fit">
            ...
            <div className="mt-5">
              {!appliedCoupon ? (
                <>
                  ...
                  className="w-full bg-violet-50 border border-violet-300 rounded-xl py-3 font-semibold text-violet-700 hover:bg-violet-100 transition"
                >
                            ...
                            <div className="flex justify-between items-center gap-3">
                              ...
                              <button
                                ...
                                className={`px-4 py-2 rounded-xl font-semibold ${
                                  coupon.eligible
                                    ? "bg-gradient-to-r from-violet-700 to-purple-600 text-white shadow-xl hover:bg-violet-800"
