...
function AddProduct() {
  ...
  return (
    <DashboardLayout role="vendor">
      ...
      >
        <div className="bg-white/95 backdrop-blur-xl border-b border-violet-100 rounded-3xl shadow p-6 space-y-5">
          <div>
          ...
          <div>
            ...
            <textarea
              className="border rounded-xl p-3 w-full mt-2 outline-none focus:ring-2 focus:ring-violet-600 min-h-28"
        ...
        <div className="bg-white/95 backdrop-blur-xl border-b border-violet-100 rounded-3xl shadow p-6 h-fit">
          ...
          <button
            disabled={loading}
            className="w-full bg-gradient-to-r from-violet-700 to-violet-800 text-white py-3 rounded-xl font-semibold mt-6 disabled:opacity-60"
          >
