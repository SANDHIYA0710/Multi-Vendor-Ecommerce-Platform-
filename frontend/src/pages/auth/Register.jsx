...
function Register() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-gradient-to-br from-slate-50 via-violet-50 to-violet-100 px-5 py-4">
      <div className="h-full max-w-6xl mx-auto flex flex-col">
        <header className="h-12 flex items-center justify-between">
          <Link to="/" className="text-2xl font-extrabold text-slate-900">
           <span className="text-violet-700">Velora</span>
          </Link>
          ...
          <div className="text-sm text-slate-600">
            ...
            <Link
              to="/login"
              className="ml-2 border border-violet-700 text-violet-700 px-4 py-2 rounded-lg font-semibold hover:bg-violet-700 hover:text-white"
            >
              Login
            </Link>
          </div>
        ...
        <main className="flex-1 min-h-0 flex items-center">
          <div className="w-full h-[calc(100vh-96px)] bg-white/95 backdrop-blur-xl border-b border-violet-100 rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-[35%_65%]">
            <aside className="hidden lg:flex bg-gradient-to-br from-violet-50 to-violet-100 p-8 flex-col justify-between">
              <div>
                ...
                <h1 className="text-4xl font-extrabold text-slate-900 mt-8 leading-tight">
                  Create your <br />
                  <span className="text-violet-700">Velora</span> account
                </h1>

                <p className="text-slate-600 mt-4 text-base">
                  Join customers and vendors in one growing place.
                </p>

                <div className="space-y-5 mt-8">
                  <div className="flex gap-4">
                    <div className="h-12 w-12 rounded-2xl bg-violet-100 flex items-center justify-center text-xl">
                      🛒
                    </div>
                    <div>
            ...
            <section className="flex items-center justify-center px-5 sm:px-8 py-5 overflow-y-auto lg:overflow-hidden">
              <form onSubmit={handleSubmit} className="w-full max-w-2xl">
                <div className="text-center mb-5">
                  <div className="mx-auto h-14 w-14 rounded-full bg-violet-100 flex items-center justify-center text-2xl mb-3">
                    👤
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      className="border rounded-xl px-4 py-3 w-full mt-1 outline-none focus:ring-2 focus:ring-violet-600"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="h-11 w-11 rounded-full bg-violet-100 flex items-center justify-center text-xl">
                          🛍️
                        </div>
                        <div>
                ...
                <button
                  disabled={loading}
                  className="w-full bg-gradient-to-r from-violet-700 to-violet-800 text-white py-3 rounded-xl font-semibold mt-5 hover:opacity-90 disabled:opacity-60"
                >
