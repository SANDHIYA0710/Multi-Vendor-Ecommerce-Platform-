    ...
    <DashboardLayout role="admin">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[420px_1fr] gap-6">
        ...
        >
          ...
          <button className="w-full bg-gradient-to-r from-violet-700 to-purple-600 text-white shadow-xl py-3 rounded-xl font-semibold">
            Create Coupon
          </button>
        </form>

        <div className="bg-white/95 backdrop-blur-xl border-b border-violet-100 rounded-3xl shadow overflow-hidden">
