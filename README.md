...
A **Full-Stack Multi-Vendor E-commerce Platform** built using **FastAPI, PostgreSQL, React, and Tailwind CSS**. The platform allows multiple vendors to sell products, customers to purchase from different vendors, and administrators to manage the entire place.
